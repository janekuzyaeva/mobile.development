...
export class API {
  ...
  public get(url: string, header: HttpHeaders) { // извлечение данных
    let requestOptions = {
      headers: header
    };
  ...
  public post(url: string, data, header: HttpHeaders) { //отпраавка
    let requestOptions = {
      headers: header
    };
  ...
  public put(url: string, data, header: HttpHeaders) {//изменение
    let requestOptions = {
      headers: header
    };
